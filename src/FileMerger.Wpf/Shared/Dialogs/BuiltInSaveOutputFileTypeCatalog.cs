...
{
    private static readonly SaveOutputFileTypeDefinition Text =
        new(".txt", "Text", isDefault: true);

    private static readonly SaveOutputFileTypeDefinition Markdown =
        new(".md", "Markdown");

    private static readonly SaveOutputFileTypeDefinition Log =
        new(".log", "Log");
